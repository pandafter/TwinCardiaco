    ...
    <div className="flex min-h-0 flex-col gap-2.5">
      ...
      <Card className="flex min-h-0 flex-[1.05] flex-col overflow-hidden">
        ...
        <div className="relative flex min-h-0 flex-1 items-center">
          ...
          />
          {/* El corazón va aquí, al lado de la cadena causal, porque es la
              primera pieza de esa cadena: la sístole que no se acorta es la
              explicación de PULSO ↑ → LLENADO ↓, sin rotularla. Cae solo a 2D
              si no hay WebGL2. */}
